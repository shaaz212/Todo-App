                ...
                <div className='flex-row w-4/5'>
                    {
                        ...
                        showTask.map((todo,index)=>(
                            <div className='flex items-center border-1 border-green-900 text-green-200  h-20 py-2 mb-2'>
                            <p className='w-5 ms-4 text-2xl'>{index+1}</p>
                            <p className='w-80 text-2xl ms-10'>{todo.task}</p>
                            <Button onClick={()=>showEdit(todo,index)}  variant="outline-warning" className='ms-auto'><i className='fa-solid fa-pen-to-square fa-xs'></i></Button>
                            <Button variant="outline-danger" className='ms-5 me-5' onClick={()=>dispatch(deleteFromTodo(todo.id))}><i className='fa-solid fa-trash fa-xs'></i></Button>
                        </div>
                        )):null    
                    }
                </div>
